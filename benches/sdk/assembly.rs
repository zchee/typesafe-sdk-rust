...
fn header_map() -> HeaderMap {
    ...
    headers.insert("user-agent", HeaderValue::from_static("typesafe-sdk-rust/0.1.0"));
    headers.insert("x-typesafe-sdk", HeaderValue::from_static("typesafe-sdk-rust/0.1.0"));
