...
//!
//! Every test needs `TYPESAFE_API_KEY` and fails without it; see
//! [`live_client`]. Run them with
//! `cargo nextest run -p typesafe-sdk-rust-live-tests`; nothing else in the
